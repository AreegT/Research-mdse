...
/**
 * This is the item provider adapter for a {@link aseproject.Repository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepositoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Repository_name_feature",
								"_UI_Repository_type"),
						AseprojectPackage.Literals.REPOSITORY__NAME, true, false, false,
	...
	protected void addIntelligentraterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Repository_intelligentrater_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Repository_intelligentrater_feature",
								"_UI_Repository_type"),
						AseprojectPackage.Literals.REPOSITORY__INTELLIGENTRATER, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case AseprojectPackage.REPOSITORY__NAME:
