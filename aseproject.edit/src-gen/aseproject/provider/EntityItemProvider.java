...
/**
 * This is the item provider adapter for a {@link aseproject.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						AseprojectPackage.Literals.ENTITY__NAME, true, false, false,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Entity_location_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_location_feature",
								"_UI_Entity_type"),
						AseprojectPackage.Literals.ENTITY__LOCATION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addRiskPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Entity_risk_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Entity_risk_feature", "_UI_Entity_type"),
						AseprojectPackage.Literals.ENTITY__RISK, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AseprojectPackage.Literals.ENTITY__FEEDBACK);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case AseprojectPackage.ENTITY__NAME:
		case AseprojectPackage.ENTITY__LOCATION:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case AseprojectPackage.ENTITY__FEEDBACK:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(AseprojectPackage.Literals.ENTITY__FEEDBACK,
