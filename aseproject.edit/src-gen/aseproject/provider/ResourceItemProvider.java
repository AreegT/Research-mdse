...
/**
 * This is the item provider adapter for a {@link aseproject.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Resource_name_feature",
								"_UI_Resource_type"),
						AseprojectPackage.Literals.RESOURCE__NAME, true, false, false,
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Resource_condition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Resource_condition_feature",
								"_UI_Resource_type"),
						AseprojectPackage.Literals.RESOURCE__CONDITION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case AseprojectPackage.RESOURCE__NAME:
		case AseprojectPackage.RESOURCE__CONDITION:
